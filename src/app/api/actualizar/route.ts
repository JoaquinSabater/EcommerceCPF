...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    const {
      ...
      categoria_best_sellers,
      categoria_magsafe,
      categoria_ofertas,
      categoria_iphone,
      categoria_nuevos_ingresos,
    ...
    const [result]: any = await db.query(
      ...
      [
        ...
        destacar ? 1 : 0, 
        activo ? 1 : 0,
        categoria_best_sellers ? 1 : 0,
        categoria_magsafe ? 1 : 0,
        categoria_ofertas ? 1 : 0,
        categoria_iphone ? 1 : 0,
        categoria_nuevos_ingresos ? 1 : 0,
        interior || null,
