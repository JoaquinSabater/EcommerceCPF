              ...
              {categorias.length === 0 && (
                <div className="text-center py-12">
                  <p className="text-gray-500 text-lg">
                    {selectedMarca 
                      ? `No hay vidrios templados de ${selectedMarca.nombre} disponibles en este momento.`
                      : 'No hay vidrios templados disponibles en este momento.'
                    }
                  </p>
                </div>
              )}
